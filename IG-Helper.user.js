...
// @require            https://cdn.jsdelivr.net/npm/mediabunny@1.35.0/dist/bundles/mediabunny.min.cjs
...
if (navigator.userAgent.includes('SM-X926B')) {
  durata = 6000;
} else {
  durata = 12000;
}
...
setTimeout(() => {
        ...
        if (isDownload) {
            ...
            if (!$('.IG_DWHISTORY').length) {
                ...
                if ($element != null) {
                    ...
                    if ($('div:not([class]):not([style]) > .x1ned7t2').children().length > 1) {
    ...
    function callNotification() {
        ...
        const remoteScriptURL = 'https://raw.githubusercontent.com/znoow/aerocbu/refs/heads/main/IG-Helper.user.js';
        ...
        GM_xmlhttpRequest({
            ...
            onload: function (response) {
                ...
                if (match && match[1]) {
                    ...
                    const notificationdate = GM_getValue('ZA_NOTIFICATION_DATE', '');

                    if (remoteVersion !== currentVersion && notificationdate !== today) {
                        GM_setValue('ZA_NOTIFICATION_DATE', today);
                        GM_notification({
