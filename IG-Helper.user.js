...
// @downloadURL https://raw.githubusercontent.com/znoow/aerocbu/main/IG-Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/404535/IG%20Helper.meta.js
// ==/UserScript==

(function($) {
setTimeout(() => {
    setInterval(() => { reloadScript?.(); }, 600000);
    'use strict';
    ...
    var timer = setInterval(function(){
        // page loading
        if($('div#splash-screen').length > 0 && !$('div#splash-screen').is(':hidden')) return;
